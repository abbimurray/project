...
public class viewCharging_Station {
    public static void main( String[] args ){
        ...
        try
        {
            ...
            pstat = connection.prepareStatement("SELECT *  FROM charging_station");
            // query data in the table
            resultSet = pstat.executeQuery();
            // process query results
            ResultSetMetaData metaData = resultSet.getMetaData();
            int numberOfColumns = metaData.getColumnCount(); System.out. println ( "charging_station Table of EV Charging Database:\n" );
